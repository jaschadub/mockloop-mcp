...
async def main():
    ...
    try:
        ...
        print(f"✅ Mock plugin created successfully!")
    ...
    try:
        ...
        print(f"✅ Proxy plugin created successfully!")
        print(f"   Plugin ID: {proxy_plugin.get('plugin_id', 'N/A')}")
        print(f"   Target URL: https://jsonplaceholder.typicode.com")
